    ...
    <View style={{ flex: 1, backgroundColor: '#f9fafb' }}>
          ...
          <View className="flex-row items-center justify-between">
            ...
            >
              <View className="h-10 w-10 rounded-full border-2 border-white/70 overflow-hidden bg-white/10">
                <Image
                  source={user?.avatarUrl || user?.avatar ? { uri: getFullImageUrl(user?.avatarUrl || user?.avatar) } : require('../../assets/images/logo.png')}
            ...
            <View className="flex-row items-center gap-3">
              <TouchableOpacity
                ...
                onPress={() => router.push({ pathname: '/(doctor)/messages', params: { tab: 'notifications' } })}
              >
                <Ionicons
      ...
      >
        ...
        <Tab
          ...
          label="Applications"
          active={pathname.endsWith('/applications')}
          onPress={() => router.push('/(doctor)/(tabs)/applications')}
        />
        ...
        <Tab
          ...
          onPress={() => router.push('/(doctor)/(tabs)/search')}
        />
        ...
        <Tab
          ...
          label="Active Jobs"
          active={
            pathname.endsWith('/activeJobs') ||
            pathname.endsWith('/activeJobManager')
          }
          onPress={() => router.push('/(doctor)/(tabs)/activeJobs')}
        />
