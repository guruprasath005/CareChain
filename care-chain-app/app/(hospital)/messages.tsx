...
import { useConversations, ConversationPreview } from '../../hooks/useMessages';
      ...
      <View className="flex-1 ml-3">
        ...
        <View className="flex-row items-center mt-1">
          <View className={`px-2 py-1 rounded-full flex-row items-center ${tag.container}`}>
            <Ionicons name={tag.icon} size={12} className="text-brand-primary" />
  ...
  return (
    <View className="items-center py-12">
      ...
      <Text className="text-gray-500 text-center px-8">
        When you reach out to candidates or they apply to your jobs, conversations will appear here.
      </Text>
    </View>
  );
}
  ...
  if (selectedConversation) {
    return (
      <ChatScreen
        ...
        invitationStatus={selectedConversation.invitationStatus}
      />
    );
  }
          ...
          <View className="w-full max-w-2xl self-center">
            <View className="flex-row items-center">
              ...
              <View>
                ...
                <Text className="text-gray-600 text-sm font-medium mt-1">Chat with candidates & employees</Text>
              </View>
            </View>
            ...
            <View className="mt-6 flex-row justify-around">
              <TouchableOpacity
                ...
                activeOpacity={0.9}
                className={`px-4 py-2 rounded-lg ${activeTab === 'messages' ? 'bg-brand-primary' : 'bg-gray-100'}`}
              >
                <View className="flex-row items-center">
                  <Text
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.9}
                className={`ml-3 px-4 py-2 rounded-lg ${activeTab === 'notifications' ? 'bg-brand-primary' : 'bg-gray-100'
                  }`}
              >
                <View className="flex-row items-center">
                  <Text
